...
public class MovieService {
    ...
    //관련된 엔티티도 업데이트
    public void saveTodayBoxOffice() {
        try {
...
//            JsonNode audiChange = movie.path("audiChange"); //전일 대비 관객수 증감 소숫점
                ...
                if (movieObj.isPresent()) {
                    ...
                    Optional<MovieDailyStat> movieDailyStatObj = movieDailyStatRepository.findByDayAndMovieId(currentDay, movie_id);
                    ...
                    if (movieDailyStatObj.isPresent()) {
                        ...
                        movieDailyStatObj = movieDailyStatRepository.findByMovieId(movie_id);
