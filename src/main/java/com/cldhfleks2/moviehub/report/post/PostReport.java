...
@Getter
@Setter
@SQLDelete(sql = "UPDATE post_report SET status = 0 WHERE id = ?")
@ToString
@NoArgsConstructor
public class PostReport {
    ...
    @ToString.Exclude
    @ManyToOne
    private Post post; //신고할 게시글

    @Builder(builderMethodName = "create")
    public PostReport(Boolean INAPPROPRIATE, Boolean MISINFORMATION, Boolean HATE, Boolean ABUSIVE,
                      Boolean COPYRIGHT, Boolean SPAM, String reportDetail, Member member, Post post) {
